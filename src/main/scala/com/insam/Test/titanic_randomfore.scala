...
//    }
    ...
    val (dataDFRaw, predictDFRaw) = loadData("/home/insam/09_data/Titanic_Disater/train.csv", "/home/insam/09_data/Titanic_Disater/test.csv", spark)
    ...
    predictions
      ...
      .format("csv")
      .option("header", "true")
      .save("/home/insam/09_data/Titanic_Disater/Result_RF")
  }
